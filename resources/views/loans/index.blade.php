...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight text-gray-900 dark:text-gray-100">Pinjaman Aktif</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto sm:rounded-lg">
            <div class="mx-auto sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                            ...
                            @foreach($loans as $loan)
                                ...
                                @if ($loop->last)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            class="px-6 py-4 text-sm leading-5 whitespace-no-wrap border-gray-200">
                                            <a href="{{ route('loans.terminate', ['loan' => $loan->id]) }}">Kembalikan Buku</a>
                                        </td>
                                    </tr>
                                @else
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                @else
                    <h1 class="m-6 text-xl font-semibold text-center">Anda tidak memiliki pinjaman aktif</h1>
                @endif
            </div>
        </div>
    </div>
