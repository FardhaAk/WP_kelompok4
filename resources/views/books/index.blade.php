    ...
    <div class="py-12">
        <div class="mx-auto py-2 sm:rounded-lg bg-white dark:bg-gray-800 shadow-sm">
            <div class="mx-auto sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                <h2 class="m-6 text-xl font-semibold text-gray-900 dark:text-gray-100 text-center">Perpustakaan</h2>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                @auth
                                    ...
                                    @if($book->canBeBorrowed())
                                        <a href="{{ route('loans.create', ['book' => $book->id]) }}">meminjam buku</a>
                                    @else
                                        <p class="text-red-600">Tidak ada salinan</p>
                                        @endif
                                    </td>
                                @endif
                            </tr>
